...
AGAIN:
	CALL MATRIX_SET_1 ;SET THE CHARACTER WE WANT TO DISPLAY
	CALL MATRIX_WRITE_1S ;WRITE IT TO THE LED MATRIX
	CALL MATRIX_SET_2 ;SET THE CHARACTER WE WANT TO DISPLAY
	CALL MATRIX_WRITE_1S ;WRITE IT TO THE LED MATRIX
	CALL MATRIX_SET_3 ;SET THE CHARACTER WE WANT TO DISPLAY
	CALL MATRIX_WRITE_1S ;WRITE IT TO THE LED MATRIX
	GOTO AGAIN
...
MATRIX_CLEAR:
	...
	CALL MATRIX_SET_1 ;SET PREVIEUS CHAR
