...
it easy to design characters with LED you can find it <a href="www.avrprojects.info/files/files/Matrix-Display-designer.zip" title="Matrix Display Designer">here</a>.
</p>
<p>
